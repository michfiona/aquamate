        ...
        <div class="container-fluid pt-5">
            <div class="container">
                <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                    <h6 class="text-primary text-uppercase">Forgot Password?</h6>
                    <h1 class="display-5 text-uppercase mb-0">Get new Password</h1>
                </div>
                <div class="row g-5">
                    <div class="col-lg-7">
                        <form action="" method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-12 mt-4 pt-2">
                                    <input type="submit" value="Send Mail" class="bg-primary py-2 px-3 border-0 w-100"
                                        name="send_username">
                                </div>
                                <br>
                                New Password will be sent to the mail-id registered with your username
                            </div>
                        </form>
