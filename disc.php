            ...
            <div class="col-lg-4 text-center border-start border-end py-2">
                <div class="d-inline-flex align-items-center">
                    ...
                    <div class="text-start">
                        ...
                        <span><a href="https://www.instagram.com/liaaquariumandpets/?igshid=MjljNjAzYmU%3D">Instagram</a></span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 text-center py-2">
        ...
        <div class="navbar-nav ms-auto py-0">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu m-0">
                    <a href="price.php" class="dropdown-item">Ornamental Fish</a>
                    <a href="team.php" class="dropdown-item">Aquariums</a>
                    <a href="testimonial.php" class="dropdown-item">Birds</a>
                    <a href="blog.php" class="dropdown-item">Pet Food</a>
                    <a href="detail.php" class="dropdown-item">Medicine</a>
                    <a href="detail.php" class="dropdown-item">Accessories</a>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-md-6 text-center text-md-end">
                    <p class="mb-0">Designed by <a class="text-white" href="https://phpcodex.com">php Codex</a></p>
                </div>
            </div>
        </div>
    </div>
