    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                ...
                <?php
                if(!isset($_SESSION['username'])){
                                echo "<p>You have to login first to avail our services</p>";
                }
                ?>
            </div>
            <br>
            <div class="row g-5">
                <!--<div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            <h5 class="text-uppercase mb-3">Aquarium Set-up</h5>
                            <p>We will set up the beautiful aquarium at your home</p>
                            <a class="text-primary text-uppercase" href="setup.php">Read More<i class="bi bi-chevron-right"></i></a>
                        </div>
                    </div>
                </div>-->
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            <h5 class="text-uppercase mb-3">Aquarium Servicing</h5>
                            <p>Cleaning and servicing of your Aquarium</p>
                            
                            <?php
                            if(!isset($_SESSION['username'])){
                            echo "<a class='text-primary text-uppercase' href='./users_area/user_login.php'>Read More<i class='bi bi-chevron-right'></i></a>";
                            }
                            else{
                                echo "<a class='text-primary text-uppercase' href='./users_area/clean.php'>Read More<i class='bi bi-chevron-right'></i></a>";
                            }
                            ?>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        <i class="bi-chat-square-text display-1 text-primary me-4"></i>
                        <div>
                            <h5 class="text-uppercase mb-3">Customize Aquarium Tanks</h5>
                            <p>Choose the color and design for your Aquarium Tank</p>
                            <?php
                            if(!isset($_SESSION['username'])){
                            echo "<a class='text-primary text-uppercase' href='./users_area/user_login.php'>Read More<i class='bi bi-chevron-right'></i></a>";
                            }
                            else{
                                echo "<a class='text-primary text-uppercase' href='./users_area/customize.php'>Read More<i class='bi bi-chevron-right'></i></a>";
                            }
                            ?>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        <i class="bi-chat-dots display-1 text-primary me-4"></i>
                        <div>
                            <h5 class="text-uppercase mb-3">Feedback</h5>
                            <p>Give your feedback and help us provide better service</p>
                            <?php
                            if(!isset($_SESSION['username'])){
                            echo "<a class='text-primary text-uppercase' href='./users_area/user_login.php'>Read More<i class='bi bi-chevron-right'></i></a>";
                            }
                            else{
                                echo "<a class='text-primary text-uppercase' href='./users_area/feed.php'>Read More<i class='bi bi-chevron-right'></i></a>";
                            }
                            ?>
                        </div>
                    </div>
